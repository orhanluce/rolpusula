...
This is a private candidate workspace, not the RolPusula distribution repository.
...
Imported browser data does not establish professional claims until confirmed.
Do not infer sensitive attributes or score age, sex, health, religion, ethnicity,
family status, or other protected characteristics. Evaluate job-related skills
and confirmed work constraints. AI fit scores are heuristic, not hiring probability.
Search requires the user's chosen portals and geography; do not enable every
portal automatically. Keep remote research and optional integrations explicit.
